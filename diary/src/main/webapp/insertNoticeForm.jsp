...
<body>
	...
	<table class="table table-bordered">
		<tr class="center">
			<td colspan="2" class="table-danger"><h3>&#9997;노트 입력</h3></td>
		</tr>
		<tr>
			<td class="center">note_title</td>
			<td class="center">
				<input type="text" name="noticeTitle">
			</td>
		</tr>
		<tr>
			<td class="center">note_content</td>
			<td class="center">
				<textarea class="form-control" rows="5" id="comment" name="noticeContent"></textarea>
			</td>
		</tr>
		<tr>
			<td class="center">note_writer</td>
			<td class="center">
				<input type="text" name="noticeWriter" class="center">
			</td>
		</tr>
		<tr>
			<td class="center">note_pw</td>
			<td class="center">
